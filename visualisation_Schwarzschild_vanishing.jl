...
if match_result !== nothing
    beta_value = parse(Int, match_result.captures[1])
    v_value = parse(Float64, match_result.captures[2])
    dim_value = parse(Int, match_result.captures[3])
...
py"visualisation"(x, y, J_X_TOTALsch, J_Y_TOTALsch, n, beta_value, v_value, 20, "Schwarzschild_visualisation_$(beta_value)_$(v_value)")
