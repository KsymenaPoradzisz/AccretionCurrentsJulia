...
function prepare_project()
    ...
    packages = ["Symbolics","Glob", "Plots", "DataFrames", "CSV", "CairoMakie", "Dates", "DoubleExponentialFormulas", "FileIO", "Interpolations", "LaTeXStrings", "LinearAlgebra", "PolynomialRoots", "PyCall", "QuadGK", "StatsBase", "Symbolics"]
