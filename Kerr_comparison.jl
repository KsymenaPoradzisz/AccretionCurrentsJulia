...
for ksi in xticks
    for φ in yticks
        ...
        J_t_ABS_Kerr_tmp = J_t_ABS_Kerr(ksi, φ, 0, m_0)
        println("J_r_ABS_Kerr")
        J_r_ABS_Kerr_tmp = J_r_ABS_Kerr(ksi, φ, 0, m_0)
        println("J_φ_ABS_Kerr")
        J_φ_ABS_Kerr_tmp = J_φ_ABS_Kerr(ksi, φ, 0, m_0, M)
        println("J_t_SCATT_Kerr")
        J_t_SCATT_Kerr_tmp = J_t_SCATT_Kerr(ksi, φ, 0, m_0)
        println("J_r_SCATT_Kerr")
        J_r_SCATT_Kerr_tmp = J_r_SCATT_Kerr(ksi, φ, 0, m_0)
        println("J_φ_SCATT_Kerr")
        J_φ_SCATT_Kerr_tmp = J_φ_SCATT_Kerr(ksi, φ, 0, m_0, M)
